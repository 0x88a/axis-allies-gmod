if CLIENT then
SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/weapon_doibazooka")
...
SWEP.ViewModel = "models/weapons/doi/v_bazooka.mdl" 
SWEP.WorldModel = "models/weapons/doi/w_bazooka.mdl"
...
SWEP.Sprint = 0
SWEP.Shoot = 0
SWEP.IronSightsPos = Vector(-1.721, 0, -0.281)
SWEP.IronSightsAng = Vector(7.5, 1, 0)
SWEP.Primary.Cone = 0.02

SWEP.Primary.Sound = Sound("weapons/bazooka/bazooka_fp.wav")
...
if ( !self:CanPrimaryAttack() ) || not(Shoot == 0) || not(Sprint == 0) then return end
self:Shoot()
...
local ent = ents.Create( "ent_doibazookarocket" )
