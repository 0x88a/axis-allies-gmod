if CLIENT then
SWEP.WepSelectIcon = surface.GetTextureID("vgui/hud/weapon_doistielhandgranate")
...
SWEP.ViewModel = "models/weapons/doi/v_stielhandgranate.mdl" 
SWEP.WorldModel = "models/weapons/doi/w_stielhandgranate.mdl"
...
local ent = ents.Create( "ent_doistielhandgranate" )
