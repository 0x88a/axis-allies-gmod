...
command.new("unignite")
	...
	:Help(language.get("unignite_help"))
...
do
	...
	command.new("unfreeze")
		...
		:Help(language.get("unfreeze_help"))
...
command.new("uncloak")
	...
	:Help(language.get("uncloak_help"))
...
command.new("respawn")
	...
	:Help(language.get("respawn_help"))
...
command.new("giveammo")
	...
	:Help(language.get("giveammo_help"))
...
sam.command.new("freezeprops")
	...
	:Help(language.get("freezeprops_help"))
