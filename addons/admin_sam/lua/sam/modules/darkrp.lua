...
add("PostGamemodeLoaded", "SAM.DarkRP", function()
	...
	if not isstring(GAMEMODE.Version) or GAMEMODE.Version < "2.5" then return end
	...
	command.new("unarrest")
		...
		:Help(language.get("unarrest_help"))
	...
	command.new("setmoney")
		...
		:Help(language.get("setmoney_help"))
	...
	command.new("addmoney")
		...
		:Help(language.get("addmoney_help"))
	...
	command.new("selldoor")
		...
		:Help(language.get("selldoor_help"))
	...
	command.new("sellall")
		...
		:Help(language.get("sellall_help"))
	...
	command.new("setjailpos")
		...
		:Help(language.get("setjailpos_help"))
	...
	command.new("addjailpos")
		...
		:Help(language.get("addjailpos_help"))
	...
	do
		...
		command.new("shipment")
			...
			:Help(language.get("shipment_help"))
		...
		sam.command.new("forcename")
			...
			:Help(language.get("forcename_help"))
