...
function PANEL:Paint( w, h )
	draw.RoundedBox( 0, 0, 0, w, h, Color( 27, 27, 28, 170 ) )
	draw.RoundedBox( 0, 1, 1, w - 2, h - 2, Color( 27, 27, 28, 170 ) )
	draw.RoundedBox( 0, 2, 2, w - 4, h - 4, Color( 27, 27, 28, 170 ) )
end
...
function PANEL:Paint( w, h )
	draw.RoundedBox( 0, 0, 0, w, h, Color( 27, 27, 28, 170 ) )
	draw.RoundedBox( 0, 1, 1, w - 2, h - 2, Color( 27, 27, 284, 170 ) )
	draw.RoundedBox( 0, 2, 2, w - 4, h - 4, Color( 27, 27, 28, 170 ) )
end
